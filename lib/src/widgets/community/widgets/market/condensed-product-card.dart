...
class CondensedProductCard extends StatefulWidget {
  ...
  const CondensedProductCard({Key? key, required this.product}) : super(key: key);
            ...
            Column(
              children: [
                ClipRRect(
                  ...
                  child: Container(color: Colors.white, child: Image.asset(
                ...
                Container(
                  decoration: BoxDecoration(
                    border: Border(top: BorderSide(color: AppStyles.getPrimaryDark(themeNotifier.currentMode)))
                  ),
            ...
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppStyles.getPrimary(themeNotifier.currentMode), width: 2)
                ),
                child: CircleAvatar(
              radius: 16,
