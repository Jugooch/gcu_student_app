...
class EditClubPage extends StatefulWidget {
  final User user;
  Club club;
  EditClubPage({required this.user, Key? key, required this.club})
      : super(key: key);
...
class _EditClubPageState extends State<EditClubPage> {
  ...
  void initState() {
    super.initState();
    nameController = TextEditingController(text: widget.club.name);
    descriptionController =
        TextEditingController(text: widget.club.description);
    name = widget.club.name;
    categories = List.from(widget.club.categories);
  ...
  ///////////////////////////////////////////////////////////////////////////
  ///*TODO* Update this method to actually edit a club when connected to a database**
  ///////////////////////////////////////////////////////////////////////////
  updateClub() {
    Club editClub = Club(
        id: widget.club.id,
        ...
        image: "",
        owner: widget.club.owner,
        members: widget.club.members,
        categories: categories,
        autoAccept: autoAccept);
    print("user updating club with name: " + editClub.name);
  }
  ///////////////////////////////////////////////////////////////////////////
                ...
                children: [
                  ...
                  Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                              "You can edit your club information here. Your information will have to be re-approved, so changes may take a while to show on your club page.",
                              style: TextStyle(
