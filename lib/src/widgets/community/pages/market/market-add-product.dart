...
class AddProductPage extends StatefulWidget {
  ...
  const AddProductPage({required this.user, Key? key, required this.business}) : super(key: key);
...
class _AddProductPageState extends State<AddProductPage> {
  ...
  allInfoEntered() {
    ...
    if (name.isNotEmpty &&
        ...
        _image != null && agreementChecked == true) {
      return true;
    } else {
      return false;
    }
  ...
  createProduct() {
    Product newBusiness = Product(
        ...
        image: "",id: null, price: -1, businessId: -1, category: '', business: widget.business, featured: false);
