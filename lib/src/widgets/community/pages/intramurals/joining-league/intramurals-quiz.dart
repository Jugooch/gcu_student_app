                          ...
                          child: Column(
                            children: [
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: selectedAnswers.containsKey(index)
                                        ...
                                        : AppStyles.getPrimaryDark(themeNotifier
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    Text(question.question, style: TextStyle(color: AppStyles.getTextPrimary(themeNotifier.currentMode))),
                                    SizedBox(height: 16),
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              SizedBox(width: 8),
                                              Flexible(child: Text(choice, style: TextStyle(color: AppStyles.getTextPrimary(themeNotifier.currentMode)))),
                                            ],
                                          ),
                                        ),
                                      );
