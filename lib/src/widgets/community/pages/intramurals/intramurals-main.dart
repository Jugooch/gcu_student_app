...
class _IntramuralsPageState extends State<IntramuralsPage> {
  ...
  for (var team in teams) {
    for (var game in team.games) {
      ...
      if (game.date.isAfter(today) && (nextGame == null || game.date.isBefore(nextGame.date))) {
        nextGame = game;
      }
    }
  }
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                          ...
                          Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => IntramuralsJoinLeague()),
                        );
                      },
                      style: ButtonStyle(
                  ...
                  if (teams.isNotEmpty)
                    ...
                    Text("No teams to show... Try joining one today!"),
                  SizedBox(height: 32),
                  Text(
                    'Upcoming Game',
                    style: TextStyle(
